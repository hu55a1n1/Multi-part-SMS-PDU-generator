...
// 3.1.5: If shared memory is not in use, stats is not useable (all zero):
    ...
    *national_prefixes = 0;
    ...
    for (i = 0; i < NUMBER_OF_MODEMS; i++) {
        ...
        snprintf(devices[i].telnet_login_prompt, sizeof(devices[i].telnet_login_prompt), "%s",
                 TELNET_LOGIN_PROMPT_DEFAULT);
        snprintf(devices[i].telnet_login_prompt_ignore, sizeof(devices[i].telnet_login_prompt_ignore), "%s",
                 TELNET_LOGIN_PROMPT_IGNORE_DEFAULT);
        devices[i].telnet_password[0] = 0;
        snprintf(devices[i].telnet_password_prompt, sizeof(devices[i].telnet_password_prompt), "%s",
    ...
    *device_name = 0;
    ...
    if (File) {
        ...
        while ((result = my_getline(File, name, sizeof(name), value, sizeof(value))) != 0) {
            ...
            else if (strcasecmp(name, "suspend") == 0)
            ...
            else if (strcasecmp(name, "phonecalls") == 0)
                strcpy2(d_phonecalls, ask_value(0, name, value));
            else if (strcasecmp(name, "saved") == 0)
            ...
            else if (strcasecmp(name, "delaytime_mainprocess") == 0)
            ...
            else if (strcasecmp(name, "log_unmodified") == 0) {
            ...
            else if (strcasecmp(name, "infofile") == 0)
            ...
            else if (strcasecmp(name, "os_cygwin") == 0) {
                if ((os_cygwin = yesno_check(ask_value(0, name, value))) == -1)
                    startuperror(yesno_error, name, value);
            }
            else if (strcasecmp(name, "language_file") == 0)
            ...
            else if (strcasecmp(name, "datetime_format") == 0)
                strcpy2(datetime_format, ask_value(0, name, value));
            else if (strcasecmp(name, "logtime_format") == 0)
                strcpy2(logtime_format, ask_value(0, name, value));
            else if (strcasecmp(name, "date_filename_format") == 0)
                strcpy2(date_filename_format, ask_value(0, name, value));
            else if (strcasecmp(name, "international_prefixes") == 0 ||
            ...
            else if (strcasecmp(name, "priviledged_numbers") == 0) {
                ask_value(0, name, value);
                ...
                if (getsubparam(devices_list, newdevice + 1, device_name, sizeof(device_name))) {
                    ...
                    if (device_name[j] != 0)
                        ...
                        for (read_default = 1; read_default >= 0; read_default--) {
                            ...
                            // 3.1beta7: all errors are reported, not just the first one.
                            while (device_found &&
                                   (result = my_getline(File, name, sizeof(name), value, sizeof(value))) != 0) {
                                if (result == -1) {
                                    startuperror("Syntax error: %s\n", value);
                                    continue;
                                }
                                ...
                                if (strcasecmp(name, "number") == 0)
                                    ...
                                    if (strcasecmp(value, "high") == 0)
                                        ...
                                        if (NEWDEVICE.incoming ==
                                            0)  // For backward compatibility to older version with boolean value
                                        {
                                    ...
                                    if ((NEWDEVICE.outgoing = yesno_check(ask_value(NEWDEVICE.name, name, value))) ==
                                        -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "cs_convert") == 0) {
                                    if ((NEWDEVICE.cs_convert = yesno_check(ask_value(NEWDEVICE.name, name, value))) ==
                                        -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "pin") == 0)
                                    strcpy2(NEWDEVICE.pin, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "pinsleeptime") == 0)
                                ...
                                else if (strcasecmp(name, "send_handshake_select") == 0) {
                                    if ((NEWDEVICE.send_handshake_select = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                ...
                                else if (strcasecmp(name, "startsleeptime") == 0)
                                ...
                                else if (strcasecmp(name, "eventhandler_ussd") == 0)
                                    strcpy2(NEWDEVICE.eventhandler_ussd, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "ussd_convert") == 0)
                                ...
                                else if (strcasecmp(name, "phonecalls_purge") == 0)
                                    strcpy2(NEWDEVICE.phonecalls_purge, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "phonecalls_error_max") == 0)
                                ...
                                else if (strcasecmp(name, "primary_memory") == 0) {
                                    ask_value(NEWDEVICE.name, name, value);
                                    while ((p = strchr(value, '\"')))
                                        strcpyo(p, p + 1);
                                    strcpy2(NEWDEVICE.primary_memory, value);
                                }
                                else if (strcasecmp(name, "secondary_memory") == 0) {
                                    ask_value(NEWDEVICE.name, name, value);
                                    while ((p = strchr(value, '\"')))
                                        strcpyo(p, p + 1);
                                    strcpy2(NEWDEVICE.secondary_memory, value);
                                }
                                else if (strcasecmp(name, "secondary_memory_max") == 0)
                                    NEWDEVICE.secondary_memory_max = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "pdu_from_file") == 0)
                                    strcpy2(NEWDEVICE.pdu_from_file, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "sending_disabled") == 0) {
                                    if ((NEWDEVICE.sending_disabled = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "modem_disabled") == 0) {
                                    if ((NEWDEVICE.modem_disabled = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "decode_unicode_text") == 0) {
                                    if ((NEWDEVICE.decode_unicode_text = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "internal_combine") == 0) {
                                    if ((NEWDEVICE.internal_combine = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "internal_combine_binary") == 0) {
                                    if ((NEWDEVICE.internal_combine_binary = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "pre_init") == 0) {
                                    if ((NEWDEVICE.pre_init = yesno_check(ask_value(NEWDEVICE.name, name, value))) ==
                                        -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "admin_to") == 0)
                                    strcpy2(NEWDEVICE.admin_to, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "message_limit") == 0)
                                    NEWDEVICE.message_limit = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "message_count_clear") == 0)
                                    NEWDEVICE.message_count_clear = atoi(ask_value(NEWDEVICE.name, name, value)) * 60;
                                else if (strcasecmp(name, "keep_open") == 0) {
                                    if ((NEWDEVICE.keep_open = yesno_check(ask_value(NEWDEVICE.name, name, value))) ==
                                        -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "regular_run") == 0)
                                    strcpy2(NEWDEVICE.dev_rr, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "regular_run_post_run") == 0)
                                ...
                                else if (strcasecmp(name, "regular_run_cmdfile") == 0)
                                    strcpy2(NEWDEVICE.dev_rr_cmdfile, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "regular_run_cmd") == 0) {
                                    ask_value(NEWDEVICE.name, name, value);
                                ...
                                else if (strcasecmp(name, "regular_run_logfile") == 0)
                                    strcpy2(NEWDEVICE.dev_rr_logfile, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "regular_run_loglevel") == 0) {
                                    ask_value(NEWDEVICE.name, name, value);
                                    NEWDEVICE.dev_rr_loglevel = set_level(NEWDEVICE.name, name, value);
                                }
                                else if (strcasecmp(name, "regular_run_statfile") == 0)
                                    ...
                                    NEWDEVICE.loglevel = set_level(NEWDEVICE.name, name,
                                                                   ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "check_network") == 0) {
                                    ...
                                    for (j = 1; ; j++) {
                                        ...
                                        if (getsubparam(value, j, tmp, sizeof(tmp))) {
                                            ...
                                            while (*p)
                                                p = strchr(p, 0) + 1;
                                            if ((ssize_t) strlen(tmp) <=
                                                SIZE_PRIVILEDGED_NUMBERS - 2 - (p - NEWDEVICE.priviledged_numbers)) {
                                                strcpy(p, tmp);
                                                *(p + strlen(tmp) + 1) = 0;
                                            }
                                            else
                                                startuperror(
                                                        "Not enough space for priviledged incoming numbers in device %s.\n",
                                                        NEWDEVICE.name);
                                        }
                                        else
                                            break;
                                ...
                                else if (strcasecmp(name, "read_timeout") == 0)
                                    NEWDEVICE.read_timeout = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "ms_purge_hours") == 0)
                                    NEWDEVICE.ms_purge_hours = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "ms_purge_minutes") == 0)
                                    NEWDEVICE.ms_purge_minutes = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "ms_purge_read") == 0) {
                                    if ((NEWDEVICE.ms_purge_read = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "detect_message_routing") == 0) {
                                    if ((NEWDEVICE.detect_message_routing = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "detect_unexpected_input") == 0) {
                                    if ((NEWDEVICE.detect_unexpected_input = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "unexpected_input_is_trouble") == 0) {
                                    if ((NEWDEVICE.unexpected_input_is_trouble = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "adminmessage_limit") == 0)
                                    NEWDEVICE.adminmessage_limit = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "adminmessage_count_clear") == 0)
                                    NEWDEVICE.adminmessage_count_clear =
                                            atoi(ask_value(NEWDEVICE.name, name, value)) * 60;
                                else if (strcasecmp(name, "voicecall_ignore_modem_response") == 0) {
                                    if ((NEWDEVICE.voicecall_ignore_modem_response = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "voicecall_hangup_ath") == 0) {
                                    if ((NEWDEVICE.voicecall_hangup_ath = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "voicecall_vts_quotation_marks") == 0) {
                                    if ((NEWDEVICE.voicecall_vts_quotation_marks = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "voicecall_cpas") == 0) {
                                    if ((NEWDEVICE.voicecall_cpas = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "voicecall_clcc") == 0) {
                                    if ((NEWDEVICE.voicecall_clcc = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "status_signal_quality") == 0) {
                                    if ((NEWDEVICE.status_signal_quality = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "status_include_counters") == 0) {
                                    if ((NEWDEVICE.status_include_counters = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "communication_delay") == 0)
                                    NEWDEVICE.communication_delay = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "hangup_incoming_call") == 0) {
                                    if ((NEWDEVICE.hangup_incoming_call = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "max_continuous_sending") == 0)
                                    NEWDEVICE.max_continuous_sending = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "socket_connection_retries") == 0)
                                    NEWDEVICE.socket_connection_retries = atoi(ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "socket_connection_alarm_after") == 0)
                                    NEWDEVICE.socket_connection_alarm_after = atoi(
                                            ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "socket_connection_errorsleeptime") == 0)
                                    NEWDEVICE.socket_connection_errorsleeptime = atoi(
                                            ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "report_device_details") == 0) {
                                    if ((NEWDEVICE.report_device_details = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "using_routed_status_report") == 0) {
                                    if ((NEWDEVICE.using_routed_status_report = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "routed_status_report_cnma") == 0) {
                                    if ((NEWDEVICE.routed_status_report_cnma = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "needs_wakeup_at") == 0) {
                                    if ((NEWDEVICE.needs_wakeup_at = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "keep_messages") == 0) {
                                    if ((NEWDEVICE.keep_messages = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "trust_spool") == 0) {
                                    if ((NEWDEVICE.trust_spool = yesno_check(ask_value(NEWDEVICE.name, name, value))) ==
                                        -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "smsc_pdu") == 0) {
                                    if ((NEWDEVICE.smsc_pdu = yesno_check(ask_value(NEWDEVICE.name, name, value))) ==
                                        -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "telnet_login") == 0)
                                    strcpy2(NEWDEVICE.telnet_login, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "telnet_login_prompt") == 0)
                                    strcpy2(NEWDEVICE.telnet_login_prompt, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "telnet_login_prompt_ignore") == 0)
                                    strcpy2(NEWDEVICE.telnet_login_prompt_ignore,
                                            ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "telnet_password") == 0)
                                    strcpy2(NEWDEVICE.telnet_password, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "telnet_password_prompt") == 0)
                                    strcpy2(NEWDEVICE.telnet_password_prompt, ask_value(NEWDEVICE.name, name, value));
                                else if (strcasecmp(name, "signal_quality_ber_ignore") == 0) {
                                    if ((NEWDEVICE.signal_quality_ber_ignore = yesno_check(
                                            ask_value(NEWDEVICE.name, name, value))) == -1)
                                        startuperror(yesno_error, name, value);
                                }
                                else if (strcasecmp(name, "verify_pdu") == 0) {
                                    if ((NEWDEVICE.verify_pdu = yesno_check(ask_value(NEWDEVICE.name, name, value))) ==
                                        -1)
                                        startuperror(yesno_error, name, value);
                                }
...
int getqueue(char *name, char *directory) // Name can also be a phone number
{
    ...
    if (isdigitc(*name) || (*name && strchr("#*", *name)) ||
        (strlen(name) > 1 && *name == 's' && isdigitc(*(name + 1)))) {
#ifdef DEBUGMSG
    ...
    do {
        ...
        switch (result) {
            ...
            case 'h':
                ...
                break;
            case 'c':
                copyvalue(configfile, sizeof(configfile) - 1, optarg, "configfile commandline argument");
                break;
            case 's':
#ifndef NOSTATS
                                                                                                                                        printstatus=1;
            ...
            case 't':
                ...
                break;
            case 'V':
                printf("Version %s, Copyright (c) Keijo Kasvi, %s@%s.%s, http://smstools3.kekekasvi.com\n",
                ...
                exit(0);
            case 'i':
                copyvalue(arg_infofile, sizeof(arg_infofile) - 1, optarg, "infofile commandline argument");
                break;
            case 'p':
                copyvalue(arg_pidfile, sizeof(arg_pidfile) - 1, optarg, "pidfile commandline argument");
                break;
            case 'l':
                copyvalue(arg_logfile, sizeof(arg_logfile) - 1, optarg, "logfile commandline argument");
                break;
            case 'n':
                // 3.1.7: This is handled in the main() code.
                break;
            case 'u':
                copyvalue(arg_username, sizeof(arg_username) - 1, optarg, "username commandline argument");
                break;
            case 'g':
                copyvalue(arg_groupname, sizeof(arg_groupname) - 1, optarg, "groupname commandline argument");
                break;
            case 'C':
                copyvalue(communicate, sizeof(communicate) - 1, optarg, "Communicate commandline argument");
                break;
            case 'D':
            case 'E':
                snprintf(arg_7bit_packed, sizeof(arg_7bit_packed), "%s", optarg);
    ...
    if (dir && *dir) {
        if ((dirdata = opendir(dir))) {
            while ((ent = readdir(dirdata))) {
                ...
                if (S_ISDIR(statbuf.st_mode) == 0) if (strcmp(tmpname + strlen(tmpname) - 5, ".LOCK") == 0) if (
                        unlink(tmpname) != 0)
...
int startup_check(int result) {
    ...
    if (startup_err_str) {
        wrlogfile(NULL, "There was %i error%s while reading the config file:", startup_err_count,
                  (startup_err_count > 1) ? "s" : "");
        p = startup_err_str;
        while (p && *p) {
            if ((p2 = strchr(p, '\n')))
                *p2 = 0;
    ...
    while (queues[x].name[0] && (x < NUMBER_OF_MODEMS)) {
        if ((i = check_directory(queues[x].directory)) == 1)
            ...
            i = 0;
            while (queues[i].name[0] && (i < NUMBER_OF_MODEMS)) {
                if (i != x) if (!strcmp(queues[i].directory, queues[x].directory))
        ...
        wrlogfile(&result, "Device %s of %s specifies an inet socket, but sockets are not available in this compilation.", devices[x].device, devices[x].name);
#else
            if (DEVICE_X_IS_SOCKET) if (!strchr(devices[x].device, ':'))
                wrlogfile(&result, "%s has illegal internet host %s specified, must be @<host_or_ip>:<port>",
                          devices[x].name, devices[x].device);
#endif

            if (queues[0].name[0]) if (devices[x].queues[0][0] == 0)
            ...
            if (devices[x].eventhandler[0] && strcmp(eventhandler, devices[x].eventhandler) != 0 && executable_check) {
                if (!(fp = fopen(devices[x].eventhandler, "r")))
                    wrlogfile(&result, "%s eventhandler %s cannot be read: %s", devices[x].name,
                              devices[x].eventhandler, strerror(errno));
                else {
                    fclose(fp);
                    if (!is_executable(devices[x].eventhandler))
                        wrlogfile(&result, "%s eventhandler %s is not executable for smsd.", devices[x].name,
                                  devices[x].eventhandler);
                }
            }

            if (devices[x].eventhandler_ussd[0] && strcmp(eventhandler, devices[x].eventhandler_ussd) != 0 &&
                strcmp(devices[x].eventhandler, devices[x].eventhandler_ussd) != 0 && executable_check) {
                if (!(fp = fopen(devices[x].eventhandler_ussd, "r")))
                    wrlogfile(&result, "%s eventhandler_ussd %s cannot be read: %s", devices[x].name,
                              devices[x].eventhandler_ussd, strerror(errno));
                else {
                    fclose(fp);
                    if (!is_executable(devices[x].eventhandler_ussd))
                        wrlogfile(&result, "%s eventhandler_ussd %s is not executable for smsd.", devices[x].name,
                                  devices[x].eventhandler_ussd);
                }
            }
            ...
            if (devices[x].pdu_from_file[0]) {
                ...
                if (!value_in(devices[x].check_memory_method, 2, CM_NO_CPMS, CM_CPMS))
                    wrlogfile(&result,
                              "Device %s uses pdu_from_file but it can be used only with check_memory_method values %i or %i.",
                              devices[x].name, CM_NO_CPMS, CM_CPMS);
            }

            if (devices[x].dev_rr[0] && executable_check) {
                if (!(fp = fopen(devices[x].dev_rr, "r")))
                    wrlogfile(&result, "%s regular_run file %s cannot be read: %s", devices[x].name, devices[x].dev_rr,
                              strerror(errno));
                else {
                    fclose(fp);
                    if (!is_executable(devices[x].dev_rr))
                        wrlogfile(&result, "%s regular_run file %s is not executable for smsd.", devices[x].name,
                                  devices[x].dev_rr);
                }
            }

            if (devices[x].dev_rr_post_run[0] && executable_check &&
                strcmp(devices[x].dev_rr, devices[x].dev_rr_post_run)) {
                if (!(fp = fopen(devices[x].dev_rr_post_run, "r")))
                    wrlogfile(&result, "%s regular_run_post_run file %s cannot be read: %s", devices[x].name,
                              devices[x].dev_rr_post_run, strerror(errno));
                else {
                    fclose(fp);
                    if (!is_executable(devices[x].dev_rr_post_run))
                        wrlogfile(&result, "%s regular_run_post_run file %s is not executable for smsd.",
                                  devices[x].name, devices[x].dev_rr_post_run);
                }
            }
            ...
            if (devices[x].dev_rr_logfile[0]) {
                if (!(fp = fopen(devices[x].dev_rr_logfile, "a")))
                    wrlogfile(&result, "%s regular_run_logfile %s cannot be written: %s", devices[x].name,
                              devices[x].dev_rr_logfile, strerror(errno));
                else
                    fclose(fp);
            }
            ...
            if (devices[x].dev_rr_statfile[0]) {
                if (!(fp = fopen(devices[x].dev_rr_statfile, "a")))
                    wrlogfile(&result, "%s regular_run_statfile %s cannot be written: %s", devices[x].name,
                              devices[x].dev_rr_statfile, strerror(errno));
                else
                    fclose(fp);
                ...
                for (y = 0; y < NUMBER_OF_MODEMS; y++) {
                    if (y == x)
                        continue;
                    if (devices[y].name[0]) if (strcmp(devices[y].dev_rr_statfile, devices[x].dev_rr_statfile) == 0)
                        wrlogfile(&result, "Devices %s and %s has the same regular_run_statfile %s.", devices[x].name,
                                  devices[y].name, devices[x].dev_rr_statfile);
                }
            }

            if (devices[x].messageids < 1 || devices[x].messageids > 3)
                wrlogfile(&result, "Device %s has invalid value for messageids (%i).", devices[x].name,
                          devices[x].messageids);

            if (value_in(devices[x].check_memory_method, 5, CM_CMGL, CM_CMGL_DEL_LAST, CM_CMGL_CHECK,
                         CM_CMGL_DEL_LAST_CHECK, CM_CMGL_SIMCOM)) if (devices[x].cmgl_value[0] == 0)
                wrlogfile(&result, "Device %s uses check_memory_method %i but cmgl_value is not defined.",
                          devices[x].name, devices[x].check_memory_method);

            if (!value_in(devices[x].check_memory_method, 8, CM_NO_CPMS, CM_CPMS, CM_CMGD, CM_CMGL, CM_CMGL_DEL_LAST,
                          CM_CMGL_CHECK, CM_CMGL_DEL_LAST_CHECK, CM_CMGL_SIMCOM))
                wrlogfile(&result, "Device %s has invalid value for check_memory_method (%i).", devices[x].name,
                          devices[x].check_memory_method);

            if (devices[x].priviledged_numbers[0]) if (!value_in(devices[x].check_memory_method, 3, CM_CMGL_CHECK,
                                                                 CM_CMGL_DEL_LAST_CHECK, CM_CMGL_SIMCOM))
                wrlogfile(&result,
                          "Device %s has priviledged_numbers defined but it can only be used with check_memory_method values %i, %i or %i.",
                          devices[x].name, CM_CMGL_CHECK, CM_CMGL_DEL_LAST_CHECK, CM_CMGL_SIMCOM);

            if (devices[x].read_timeout < 1)
                wrlogfile(&result, "Device %s has invalid value for read_timeout (%i).", devices[x].name,
                          devices[x].read_timeout);

            if (devices[x].ms_purge_hours < 0)
                wrlogfile(&result, "Device %s has invalid value for ms_purge_hours (%i).", devices[x].name,
                          devices[x].ms_purge_hours);

            if (devices[x].ms_purge_minutes < 0)
                wrlogfile(&result, "Device %s has invalid value for ms_purge_minutes (%i).", devices[x].name,
                          devices[x].ms_purge_minutes);

            if (!value_in(devices[x].check_network, 3, 0, 1, 2))
                wrlogfile(&result, "Device %s has invalid value for check_network (%i).", devices[x].name,
                          devices[x].check_network);

            // 3.1.7: Devices cannot have the same port.
            for (y = 0; y < NUMBER_OF_MODEMS; y++) {
                if (y == x)
                    continue;
                if (devices[y].name[0] && devices[y].device[0]) if (strcmp(devices[y].device, devices[x].device) == 0)
                    wrlogfile(&result, "Devices %s and %s has the same port ( device = %s ).", devices[x].name,
                              devices[y].name, devices[x].device);
            }

#ifndef USE_ICONV
            if (devices[x].ussd_convert == 1)
                wrlogfile(&result,
                          "Device %s uses ussd_convert = 1, but it's only available when USE_ICONV is defined.",
                          devices[x].name);
#endif
            ...
            if (devices[x].voicecall_cpas && devices[x].voicecall_clcc)
                wrlogfile(&result,
                          "Devices %s has both voicecall_cpas and voicecall_clcc defined. Decide which one to use.",
                          devices[x].name);
    ...
    if (*adminmessage_device) {
        ...
        for (x = 0; x < NUMBER_OF_MODEMS && !i; x++) {
            if (!strcmp(devices[x].name, adminmessage_device)) {
                if (devices[x].outgoing == 0) {
                    wrlogfile(&result,
                              "Mainspooler uses %s to send administrative messages, but this device has outgoing disabled.",
                              adminmessage_device);
                    break;
                }
                ...
                if (devices[x].admin_to[0] || admin_to[0])
                    ...
                    wrlogfile(&result,
                              "Mainspooler uses %s to send administrative messages, but this device has no admin_to specified.",
                              adminmessage_device);
                    break;
                }
            }
        ...
        if (!i)
            wrlogfile(&result, "Mainspooler has invalid adminmessage_device setting (%s): device not found.",
                      adminmessage_device);
    }
    ...
    if (smart_logging) {
        ...
        for (x = 0; x < NUMBER_OF_MODEMS; x++)
            if (devices[x].name && devices[x].logfile[0]) if (strcmp(devices[x].logfile, "syslog") == 0 ||
                                                              strcmp(devices[x].logfile, "0") == 0)
                wrlogfile(&result, "Smart logging cannot be used when syslog is used for logging, device %s.",
                          devices[x].name);
    }
    ...
    if (!strchr(datetime_format, '%') ||
        strftime(timestamp, sizeof(timestamp), datetime_format, localtime(&now)) == 0 ||
        !strcmp(timestamp, datetime_format))
        wrlogfile(&result, "Format string datetime is completelly wrong: \"%s\"", datetime_format);

    if (!strchr(logtime_format, '%') || strftime(timestamp, sizeof(timestamp), logtime_format, localtime(&now)) == 0 ||
        !strcmp(timestamp, logtime_format))
        wrlogfile(&result, "Format string logtime_format is completelly wrong: \"%s\"", logtime_format);

    if (!strchr(date_filename_format, '%') ||
        strftime(timestamp, sizeof(timestamp), date_filename_format, localtime(&now)) == 0 ||
        !strcmp(timestamp, date_filename_format))
    ...
    if (filename_preview < 0 || filename_preview >= SIZE_FILENAME_PREVIEW)
        wrlogfile(&result, "Value for filename_preview is illegal: \"%d\". It can be 1 ... %u.", filename_preview,
                  SIZE_FILENAME_PREVIEW - 1);

    if (startup_err_str) {
        wrlogfile(NULL, "There was %i error%s while removing .LOCK files.", startup_err_count,
                  (startup_err_count > 1) ? "s" : "");
        p = startup_err_str;
        while (p && *p) {
            if ((p2 = strchr(p, '\n')))
                    ...
                    if (statbuf.st_size == 0) {
                        ...
                        if (stat(tmp, &statbuf) == 0) {
                            if (statbuf.st_size != 0) {
                                i = 0;
                                wrlogfile(&result,
                                          "Concatenation storage of %s cannot be moved from incoming to saved directory, "
                        ...
                        if (i) {
                            if (movefile(fname, d_saved)) {
                                ...
                                if (stat(fname, &statbuf) == 0) {
                                    if (unlink(fname) != 0) {
                                        startuperror(
                                                "Failed to move concatenation storage, cannot unlink source file %: %s\n",
                                                fname, strerror(errno));
                                        i = 0;
                                    }
                                }
                                ...
                                if (i)
                                    writelogfile(LOG_WARNING, 0,
                                                 "Moved concatenation storage of %s from incoming to saved directory",
                                                 devices[x].name);
                            }
                            else
                                wrlogfile(&result,
                                          "Failed to move concatenation storage of %s from incoming to saved directory.",
                                          devices[x].name);
                        }
                    }
                }
    ...
    if (result > 0) {
        ...
        if (*priviledged_numbers) {
            ...
            *tmp = 0;
            for (x = 0; x < NUMBER_OF_MODEMS; x++)
                if (devices[x].name[0] && devices[x].priviledged_numbers[0] == 0) if (value_in(
                        devices[x].check_memory_method, 3, CM_CMGL_CHECK, CM_CMGL_DEL_LAST_CHECK, CM_CMGL_SIMCOM))
...
#else
                writelogfile(LOG_WARNING, 0,
                             "Note that at least %s will send administrative messages, but mainspooler will not because shared memory is not available.",
                             tmp);
#endif
            }
        }
